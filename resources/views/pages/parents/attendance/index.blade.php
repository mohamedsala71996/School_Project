        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('son.attendance.show') }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="card-body datepicker-form">
                                <div class="input-group" data-date-format="yyyy-mm-dd">
                                    ...
                                    <input type="date" class="form-control" placeholder="تاريخ البداية" required
                                        name="from">
                                    <span class="input-group-addon">الي تاريخ</span>
                                    <input type="date" class="form-control" placeholder="تاريخ النهاية" required
                                        name="to">
                                </div>
                            </div>
                        </div>
