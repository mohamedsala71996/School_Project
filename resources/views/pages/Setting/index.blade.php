                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select data-placeholder="Choose..." required name="current_session"
                                        ...
                                        @for ($i = -2; $i < 2; $i++)
                                            <option
                                                {{ $lastYear + $i . '-' . $currentYear + $i == $setting['current_session'] ? 'selected' : '' }}
                                                value="{{ $lastYear + $i . '-' . $currentYear + $i }}">
                                                {{ $lastYear + $i . '-' . $currentYear + $i }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-9">
                                    <div class="mb-3">
                                        <img style="width: 100px" height="100px"
                                            src="{{ URL::asset('logo/logo/' . $setting['logo']) }}" alt="logo">
