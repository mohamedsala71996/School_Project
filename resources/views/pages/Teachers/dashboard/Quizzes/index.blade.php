                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('quizzes.edit',$quizze->id)}}"
                                                       class="btn btn-info btn-sm" role="button"  title="تعديل" aria-pressed="true"><i
                                                            class="fa fa-edit"></i></a>
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                            data-toggle="modal"
                                                            data-target="#delete_exam{{ $quizze->id }}" title="حذف"><i
                                                            class="fa fa-trash"></i></button>
                                                    <a href="{{route('question.show',$quizze->id)}}"
                                                        class="btn btn-warning btn-sm" role="button" title="عرض الاسئلة" aria-pressed="true"><i
                                                                class="fa fa-eye"></i></a>
                                                    <a href="{{route('question.show_results',$quizze->id)}}"
                                                        class="btn btn-primary btn-sm" role="button" title='عرض الطلاب الذين اجتازوا الاختبار' aria-pressed="true"> 
