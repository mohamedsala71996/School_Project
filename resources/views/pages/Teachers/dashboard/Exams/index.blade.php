            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('ExamsTeacher.create')}}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($exams as $exam)
                                            <tr>
                                                ...
                                                <td>{{$exam->term}}</td>
                                                <td>
                                                    <a href="{{route('ExamsTeacher.edit',$exam->id)}}"
                                            ...
                                            <div class="modal fade" id="delete_exam{{$exam->id}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{route('ExamsTeacher.destroy','test')}}" method="post">
                                                        {{method_field('delete')}}
                                                        {{csrf_field()}}
