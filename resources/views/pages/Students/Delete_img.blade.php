...
<div class="modal fade" id="Delete_img{{ $Images->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('delete_files') }}" method="post">
                    @csrf
                    ...
                    <input type="text" name="filename" readonly value="{{ $Images->file_name }}"
                        class="form-control">
